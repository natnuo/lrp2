      ...
      <div className={`${styles["border"]} ${styles["border-purple-300"]} ${styles["bg-gradient-to-tr"]} ${styles["from-slate-50"]} ${styles["via-white"]} ${styles["to-white"]} ${styles["text-black"]} ${styles["rounded-lg"]} ${styles["flex-grow"]} ${styles["m-32"]} ${styles["p-4"]} ${styles["gap-4"]} ${styles["flex"]}`} style={{ maxWidth: "1200px", maxHeight: "700px", filter: "drop-shadow(0 0 10px #ffe5ff)" }}>
        ...
        <div className={`${styles["flex-grow"]} ${styles["flex"]} ${styles["flex-col"]}`}>
          <div className={`${styles["flex"]} ${styles["justify-between"]} ${styles["px-4"]} ${styles["align-middle"]} ${styles["mb-4"]}`}>
            ...
            <div className={`${styles["flex"]} ${styles["gap-2"]} ${styles["h-3"]}`}>
              <div className={`${styles["flex"]} ${styles["justify-center"]} ${styles["items-center"]}`} style={{ borderRadius: "2.25px", backgroundColor: "#242938", width: "12px" }} title="Made with Chart.js">
